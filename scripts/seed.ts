...
const techniques: Technique[] = [
  ...
  { name: 'Knee on Belly', position: 'Side Control Top', type: 'Transition', description: 'Moving to knee on belly top', gi_type: 'both' },
  ...
  { name: 'Leg Lock Entry', position: 'X-Guard', type: 'Transition', description: 'Move to ashi garami', gi_type: 'both' },
  ...
  // Knee on Belly Top
  { name: 'Armbar', position: 'Knee on Belly Top', type: 'Submission', description: 'Spin to armbar', gi_type: 'both' },
  { name: 'Baseball Bat Choke', position: 'Knee on Belly Top', type: 'Submission', description: 'Cross collar choke', gi_type: 'gi' },
  { name: 'Collar Choke', position: 'Knee on Belly Top', type: 'Submission', description: 'Loop choke variation', gi_type: 'gi' },
  { name: 'Mount Transition', position: 'Knee on Belly Top', type: 'Transition', description: 'Step over to mount', gi_type: 'both' },
  { name: 'Back Take', position: 'Knee on Belly Top', type: 'Transition', description: 'Spin to the back', gi_type: 'both' },
  { name: 'Far Side Armbar', position: 'Knee on Belly Top', type: 'Submission', description: 'Armbar the far arm', gi_type: 'both' },
  { name: 'Side Control Transition', position: 'Knee on Belly Top', type: 'Transition', description: 'Return to side control', gi_type: 'both' },
  { name: 'North-South Transition', position: 'Knee on Belly Top', type: 'Transition', description: 'Spin to north-south', gi_type: 'both' },
  { name: 'Kimura', position: 'Knee on Belly Top', type: 'Submission', description: 'Kimura from knee on belly', gi_type: 'both' },
  { name: 'Straight Armbar', position: 'Knee on Belly Top', type: 'Submission', description: 'Straight armbar on near arm', gi_type: 'both' },
  { name: 'Maintaining KOB', position: 'Knee on Belly Top', type: 'Setup', description: 'Maintaining knee on belly pressure', gi_type: 'both' },

  // Knee on Belly Bottom
  { name: 'Elbow Push Escape', position: 'Knee on Belly Bottom', type: 'Escape', description: 'Push knee with elbow and hip escape', gi_type: 'both' },
  { name: 'Bridge and Roll', position: 'Knee on Belly Bottom', type: 'Escape', description: 'Bridge to off-balance and escape', gi_type: 'both' },
  { name: 'Shrimp to Half Guard', position: 'Knee on Belly Bottom', type: 'Escape', description: 'Shrimp and recover half guard', gi_type: 'both' },
  { name: 'Guard Recovery', position: 'Knee on Belly Bottom', type: 'Escape', description: 'Recover full guard', gi_type: 'both' },
  { name: 'Knee Shield', position: 'Knee on Belly Bottom', type: 'Defense', description: 'Use knee to create space', gi_type: 'both' },
  { name: 'Frame Defense', position: 'Knee on Belly Bottom', type: 'Defense', description: 'Frame on hip and knee', gi_type: 'both' },
  { name: 'Ankle Pick Reversal', position: 'Knee on Belly Bottom', type: 'Reversal', description: 'Grab ankle and reverse', gi_type: 'both' },
  { name: 'Deep Half Entry', position: 'Knee on Belly Bottom', type: 'Escape', description: 'Dive under to deep half guard', gi_type: 'both' },
  ...
  // Ashi Garami (Inside Ashi / Single Leg X position)
  { name: 'Inside Heel Hook', position: 'Ashi Garami', type: 'Submission', description: 'Inside heel hook from ashi', gi_type: 'both' },
  { name: 'Straight Ankle Lock', position: 'Ashi Garami', type: 'Submission', description: 'Basic ankle lock from ashi', gi_type: 'both' },
  { name: 'Toe Hold', position: 'Ashi Garami', type: 'Submission', description: 'Figure four toe hold', gi_type: 'both' },
  { name: 'Kneebar', position: 'Ashi Garami', type: 'Submission', description: 'Kneebar from ashi', gi_type: 'both' },
  { name: 'Saddle Entry', position: 'Ashi Garami', type: 'Transition', description: 'Transition to saddle', gi_type: 'both' },
  { name: 'Outside Ashi Entry', position: 'Ashi Garami', type: 'Transition', description: 'Switch to outside ashi', gi_type: 'both' },
  { name: 'Backside 50/50 Entry', position: 'Ashi Garami', type: 'Transition', description: 'Invert to backside 50/50', gi_type: 'both' },
  { name: 'Boot Escape', position: 'Ashi Garami', type: 'Escape', description: 'Clear the knee line', gi_type: 'both' },
  { name: 'Hip Escape Defense', position: 'Ashi Garami', type: 'Defense', description: 'Hip away to safety', gi_type: 'both' },
  { name: 'Maintaining Ashi', position: 'Ashi Garami', type: 'Setup', description: 'Controlling the position', gi_type: 'both' },

  // Outside Ashi
  { name: 'Outside Heel Hook', position: 'Outside Ashi', type: 'Submission', description: 'Outside heel hook attack', gi_type: 'both' },
  { name: 'Kneebar', position: 'Outside Ashi', type: 'Submission', description: 'Kneebar from outside ashi', gi_type: 'both' },
  { name: 'Toe Hold', position: 'Outside Ashi', type: 'Submission', description: 'Toe hold from outside ashi', gi_type: 'both' },
  { name: 'Straight Ankle Lock', position: 'Outside Ashi', type: 'Submission', description: 'Ankle lock from outside ashi', gi_type: 'both' },
  { name: 'Calf Slicer', position: 'Outside Ashi', type: 'Submission', description: 'Calf slicer from outside ashi', gi_type: 'both' },
  { name: 'Saddle Entry', position: 'Outside Ashi', type: 'Transition', description: 'Transition to saddle', gi_type: 'both' },
  { name: 'Inside Ashi Entry', position: 'Outside Ashi', type: 'Transition', description: 'Switch to inside ashi', gi_type: 'both' },
  { name: 'Boot Escape', position: 'Outside Ashi', type: 'Escape', description: 'Clear the knee line', gi_type: 'both' },
  { name: 'Maintaining Outside Ashi', position: 'Outside Ashi', type: 'Setup', description: 'Controlling the position', gi_type: 'both' },

  // Saddle (411 / Honeyhole / Inside Sankaku)
  { name: 'Inside Heel Hook', position: 'Saddle', type: 'Submission', description: 'Primary attack from saddle', gi_type: 'both' },
  { name: 'Outside Heel Hook', position: 'Saddle', type: 'Submission', description: 'Outside heel hook from saddle', gi_type: 'both' },
  { name: 'Kneebar', position: 'Saddle', type: 'Submission', description: 'Kneebar from saddle', gi_type: 'both' },
  { name: 'Toe Hold', position: 'Saddle', type: 'Submission', description: 'Toe hold from saddle', gi_type: 'both' },
  { name: 'Calf Slicer', position: 'Saddle', type: 'Submission', description: 'Calf slicer from saddle', gi_type: 'both' },
  { name: 'Cross Ashi Entry', position: 'Saddle', type: 'Transition', description: 'Transition to cross ashi', gi_type: 'both' },
  { name: 'Backside 50/50 Entry', position: 'Saddle', type: 'Transition', description: 'Invert to backside 50/50', gi_type: 'both' },
  { name: 'Backstep Escape', position: 'Saddle', type: 'Escape', description: 'Backstep to clear legs', gi_type: 'both' },
  { name: 'Boot Escape', position: 'Saddle', type: 'Escape', description: 'Clear the knee line', gi_type: 'both' },
  { name: 'Maintaining Saddle', position: 'Saddle', type: 'Setup', description: 'Controlling the saddle position', gi_type: 'both' },

  // Backside 50/50
  { name: 'Inside Heel Hook', position: 'Backside 50/50', type: 'Submission', description: 'Inside heel hook from backside', gi_type: 'both' },
  { name: 'Outside Heel Hook', position: 'Backside 50/50', type: 'Submission', description: 'Outside heel hook from backside', gi_type: 'both' },
  { name: 'Kneebar', position: 'Backside 50/50', type: 'Submission', description: 'Kneebar from backside 50/50', gi_type: 'both' },
  { name: 'Toe Hold', position: 'Backside 50/50', type: 'Submission', description: 'Toe hold from backside 50/50', gi_type: 'both' },
  { name: 'Saddle Entry', position: 'Backside 50/50', type: 'Transition', description: 'Transition to saddle', gi_type: 'both' },
  { name: 'Outside Ashi Entry', position: 'Backside 50/50', type: 'Transition', description: 'Clear to outside ashi', gi_type: 'both' },
  { name: 'Boot Escape', position: 'Backside 50/50', type: 'Escape', description: 'Clear the knee line', gi_type: 'both' },
  { name: 'Inversion Escape', position: 'Backside 50/50', type: 'Escape', description: 'Invert out of position', gi_type: 'both' },
  { name: 'Maintaining Backside 50/50', position: 'Backside 50/50', type: 'Setup', description: 'Controlling the position', gi_type: 'both' },

  // Sambo Knot (Game Over / Outside Sankaku)
  { name: 'Inside Heel Hook', position: 'Sambo Knot', type: 'Submission', description: 'Inside heel hook from sambo knot', gi_type: 'both' },
  { name: 'Outside Heel Hook', position: 'Sambo Knot', type: 'Submission', description: 'Outside heel hook from sambo knot', gi_type: 'both' },
  { name: 'Kneebar', position: 'Sambo Knot', type: 'Submission', description: 'Kneebar from sambo knot', gi_type: 'both' },
  { name: 'Toe Hold', position: 'Sambo Knot', type: 'Submission', description: 'Toe hold from sambo knot', gi_type: 'both' },
  { name: 'Calf Slicer', position: 'Sambo Knot', type: 'Submission', description: 'Calf slicer from sambo knot', gi_type: 'both' },
  { name: 'Saddle Entry', position: 'Sambo Knot', type: 'Transition', description: 'Transition to saddle', gi_type: 'both' },
  { name: 'Boot Escape', position: 'Sambo Knot', type: 'Escape', description: 'Clear the knee line', gi_type: 'both' },
  { name: 'Maintaining Sambo Knot', position: 'Sambo Knot', type: 'Setup', description: 'Controlling the position', gi_type: 'both' },

  // 50/50 Variants
  { name: '80/20 (Cross Ashi)', position: '50/50', type: 'Variant', description: 'Cross ashi position with dominant leg control', gi_type: 'both' },
  { name: '70/30', position: '50/50', type: 'Variant', description: '70/30 leg entanglement configuration', gi_type: 'both' },
  { name: '90/10', position: '50/50', type: 'Variant', description: '90/10 dominant leg entanglement configuration', gi_type: 'both' },

  // False Reap
  { name: 'Inside Heel Hook', position: 'False Reap', type: 'Submission', description: 'Inside heel hook from false reap', gi_type: 'both' },
  { name: 'Outside Heel Hook', position: 'False Reap', type: 'Submission', description: 'Outside heel hook from false reap', gi_type: 'both' },
  { name: 'Kneebar', position: 'False Reap', type: 'Submission', description: 'Kneebar from false reap', gi_type: 'both' },
  { name: 'Toe Hold', position: 'False Reap', type: 'Submission', description: 'Toe hold from false reap', gi_type: 'both' },
  { name: 'Straight Ankle Lock', position: 'False Reap', type: 'Submission', description: 'Ankle lock from false reap', gi_type: 'both' },
  { name: 'Saddle Entry', position: 'False Reap', type: 'Transition', description: 'Transition to saddle', gi_type: 'both' },
  { name: 'Ashi Garami Entry', position: 'False Reap', type: 'Transition', description: 'Transition to ashi garami', gi_type: 'both' },
  { name: '50/50 Entry', position: 'False Reap', type: 'Transition', description: 'Transition to 50/50', gi_type: 'both' },
  { name: 'Boot Escape', position: 'False Reap', type: 'Escape', description: 'Clear the knee line', gi_type: 'both' },
  { name: 'Hip Escape Defense', position: 'False Reap', type: 'Defense', description: 'Hip away to safety', gi_type: 'both' },
  { name: 'Maintaining False Reap', position: 'False Reap', type: 'Setup', description: 'Controlling the false reap position', gi_type: 'both' },

  // Truck
  { name: 'Twister', position: 'Truck', type: 'Submission', description: 'Spinal lock from the truck', gi_type: 'both' },
  { name: 'Calf Slicer', position: 'Truck', type: 'Submission', description: 'Calf slicer from truck', gi_type: 'both' },
  { name: 'Banana Split', position: 'Truck', type: 'Submission', description: 'Groin stretch submission', gi_type: 'both' },
  { name: 'Back Take', position: 'Truck', type: 'Transition', description: 'Take the back from truck', gi_type: 'both' },
  { name: 'Rear Naked Choke', position: 'Truck', type: 'Submission', description: 'RNC from truck position', gi_type: 'both' },
  { name: 'Electric Chair', position: 'Truck', type: 'Submission', description: 'Electric chair from truck', gi_type: 'both' },
  { name: 'Lockdown Entry', position: 'Truck', type: 'Transition', description: 'Entry to lockdown from truck', gi_type: 'both' },
  { name: 'Truck Entry from Half Guard', position: 'Truck', type: 'Setup', description: 'Entering truck from half guard', gi_type: 'both' },
  { name: 'Truck Entry from Back', position: 'Truck', type: 'Setup', description: 'Entering truck from back control', gi_type: 'both' },
  { name: 'Truck Escape', position: 'Truck', type: 'Escape', description: 'Escaping the truck position', gi_type: 'both' },
  { name: 'Maintaining Truck', position: 'Truck', type: 'Setup', description: 'Controlling the truck position', gi_type: 'both' },

  // Rubber Guard
  { name: 'Mission Control', position: 'Rubber Guard', type: 'Setup', description: 'Overhook head control', gi_type: 'both' },
  { name: 'New York', position: 'Rubber Guard', type: 'Setup', description: 'Overhook with opposite side underhook', gi_type: 'both' },
  { name: 'Chill Dog', position: 'Rubber Guard', type: 'Setup', description: 'Rubber guard with arm trapped', gi_type: 'both' },
  { name: 'Zombie', position: 'Rubber Guard', type: 'Setup', description: 'Double wrist control from mission control', gi_type: 'both' },
  { name: 'Meathook', position: 'Rubber Guard', type: 'Setup', description: 'Deep underhook control position', gi_type: 'both' },
  { name: 'Crackhead Control', position: 'Rubber Guard', type: 'Setup', description: 'Wrist control variation', gi_type: 'both' },
  ...
  { name: 'Invisible Collar', position: 'Rubber Guard', type: 'Submission', description: 'No-gi collar choke', gi_type: 'both' },
  { name: 'Carni', position: 'Rubber Guard', type: 'Submission', description: 'Shoulder lock from rubber guard', gi_type: 'both' },
  { name: 'Kung Fu Move', position: 'Rubber Guard', type: 'Sweep', description: 'Sweep from mission control', gi_type: 'both' },
  { name: 'Jiu Claw', position: 'Rubber Guard', type: 'Sweep', description: 'Sweep using claw grip', gi_type: 'both' },
  { name: 'Dead Orchard', position: 'Rubber Guard', type: 'Transition', description: 'Transition to omoplata setup', gi_type: 'both' },

  // Williams Guard
  { name: 'Williams Guard Setup', position: 'Williams Guard', type: 'Setup', description: 'Overhook with head control from closed guard', gi_type: 'both' },
  { name: 'Armbar', position: 'Williams Guard', type: 'Submission', description: 'Armbar from Williams guard', gi_type: 'both' },
  { name: 'Triangle', position: 'Williams Guard', type: 'Submission', description: 'Triangle from Williams guard', gi_type: 'both' },
  { name: 'Omoplata', position: 'Williams Guard', type: 'Submission', description: 'Omoplata from Williams guard', gi_type: 'both' },
  { name: 'Kimura', position: 'Williams Guard', type: 'Submission', description: 'Kimura from Williams guard', gi_type: 'both' },
  { name: 'Guillotine', position: 'Williams Guard', type: 'Submission', description: 'Guillotine from Williams guard', gi_type: 'both' },
  { name: 'Back Take', position: 'Williams Guard', type: 'Transition', description: 'Take the back from Williams guard', gi_type: 'both' },
  { name: 'Sweep', position: 'Williams Guard', type: 'Sweep', description: 'Sweep from Williams guard', gi_type: 'both' },
  { name: 'Rubber Guard Transition', position: 'Williams Guard', type: 'Transition', description: 'Transition to rubber guard', gi_type: 'both' },
  { name: 'Hip Bump Sweep', position: 'Williams Guard', type: 'Sweep', description: 'Hip bump from Williams guard', gi_type: 'both' },

  // Kesa Gatame (Scarf Hold)
  { name: 'Americana', position: 'Kesa Gatame', type: 'Submission', description: 'Americana from kesa gatame', gi_type: 'both' },
  { name: 'Armbar', position: 'Kesa Gatame', type: 'Submission', description: 'Armbar from kesa gatame', gi_type: 'both' },
  { name: 'Arm Crush', position: 'Kesa Gatame', type: 'Submission', description: 'Arm crush against your body', gi_type: 'both' },
  { name: 'Head and Arm Choke', position: 'Kesa Gatame', type: 'Submission', description: 'Arm triangle from kesa', gi_type: 'both' },
  { name: 'Wrist Lock', position: 'Kesa Gatame', type: 'Submission', description: 'Wrist lock from kesa', gi_type: 'both' },
  { name: 'Transition to Mount', position: 'Kesa Gatame', type: 'Transition', description: 'Move to mount position', gi_type: 'both' },
  { name: 'Transition to Side Control', position: 'Kesa Gatame', type: 'Transition', description: 'Move to side control', gi_type: 'both' },
  { name: 'Transition to North-South', position: 'Kesa Gatame', type: 'Transition', description: 'Move to north-south', gi_type: 'both' },
  { name: 'Maintaining Kesa Gatame', position: 'Kesa Gatame', type: 'Setup', description: 'Controlling the scarf hold', gi_type: 'both' },
  { name: 'Bridge Escape', position: 'Kesa Gatame', type: 'Escape', description: 'Bridge and roll escape', gi_type: 'both' },
  { name: 'Leg Over Escape', position: 'Kesa Gatame', type: 'Escape', description: 'Bring leg over head escape', gi_type: 'both' },
  { name: 'Back Take Escape', position: 'Kesa Gatame', type: 'Escape', description: 'Take the back during escape', gi_type: 'both' },

  // Kuzure Kesa Gatame (Modified Scarf Hold)
  { name: 'Americana', position: 'Kuzure Kesa Gatame', type: 'Submission', description: 'Americana from kuzure kesa', gi_type: 'both' },
  { name: 'Armbar', position: 'Kuzure Kesa Gatame', type: 'Submission', description: 'Armbar from kuzure kesa', gi_type: 'both' },
  { name: 'Arm Crush', position: 'Kuzure Kesa Gatame', type: 'Submission', description: 'Arm crush from kuzure kesa', gi_type: 'both' },
  { name: 'Kimura', position: 'Kuzure Kesa Gatame', type: 'Submission', description: 'Kimura from kuzure kesa', gi_type: 'both' },
  { name: 'Paper Cutter Choke', position: 'Kuzure Kesa Gatame', type: 'Submission', description: 'Collar choke from kuzure kesa', gi_type: 'gi' },
  { name: 'Transition to Mount', position: 'Kuzure Kesa Gatame', type: 'Transition', description: 'Move to mount position', gi_type: 'both' },
  { name: 'Transition to Kesa Gatame', position: 'Kuzure Kesa Gatame', type: 'Transition', description: 'Move to standard kesa', gi_type: 'both' },
  { name: 'Transition to Side Control', position: 'Kuzure Kesa Gatame', type: 'Transition', description: 'Move to side control', gi_type: 'both' },
  { name: 'Maintaining Kuzure Kesa', position: 'Kuzure Kesa Gatame', type: 'Setup', description: 'Controlling modified scarf hold', gi_type: 'both' },
  { name: 'Bridge Escape', position: 'Kuzure Kesa Gatame', type: 'Escape', description: 'Bridge and roll escape', gi_type: 'both' },
  { name: 'Underhook Escape', position: 'Kuzure Kesa Gatame', type: 'Escape', description: 'Get underhook to escape', gi_type: 'both' },
  { name: 'Back Take Escape', position: 'Kuzure Kesa Gatame', type: 'Escape', description: 'Take the back during escape', gi_type: 'both' },
  ...
  { name: 'Ashi Garami Entry', position: 'High Ground', type: 'Transition', description: 'Transition to leg attacks', gi_type: 'both' },
