...
const videoData = [
  ...
  // Collar Sleeve Guard - New videos
  { position: 'Collar Sleeve Guard', technique: 'Loop Choke', title: 'Loop Choke Basics from Collar and Sleeve Guard by Greg Hamilton BJJ', instructor: 'Greg Hamilton', giType: 'gi', url: 'https://www.youtube.com/watch?v=yA2DvxCgs9M' },
  { position: 'Collar Sleeve Guard', technique: 'Loop Choke', title: 'Collar Sleeve is The BEST Guard For Beginners BJJ (If You …)', instructor: 'BIG OSS Jiu-Jitsu', giType: 'gi', url: 'https://www.youtube.com/watch?v=T7rlBhLQKWI' },
  { position: 'Collar Sleeve Guard', technique: 'Omoplata', title: 'Omoplata from Collar Sleeve Guard - A high percentage attack', instructor: 'Lachlan Giles', giType: 'gi', url: 'https://www.youtube.com/watch?v=l3RDx45pfm0' },
  { position: 'Collar Sleeve Guard', technique: 'Omoplata', title: 'Collar Sleeve Omoplata Set up to Monoplata Submission - Andre Galvao', instructor: 'André Galvão', giType: 'gi', url: 'https://www.youtube.com/watch?v=0F8Yg1RkyM8' },
  { position: 'Collar Sleeve Guard', technique: 'Overhead Sweep', title: 'Collar sleeve to triangle choke and overhead sweep (Lachlan Giles)', instructor: 'Lachlan Giles', giType: 'gi', url: 'https://www.youtube.com/watch?v=IHgdNWKK1yM' },
  { position: 'Collar Sleeve Guard', technique: 'Overhead Sweep', title: 'Week 5: Collar Sleeve to X Guard Overhead Sweep', instructor: 'Carpio Jiu Jitsu', giType: 'gi', url: 'https://www.youtube.com/watch?v=m2H2xqYhs3A' },
  { position: 'Collar Sleeve Guard', technique: 'Scissor Sweep', title: 'Week 3: Collar Sleeve to Scissor Sweep', instructor: 'BIG OSS Jiu-Jitsu Channel', giType: 'gi', url: 'https://www.youtube.com/watch?v=CIcVyZB1Ta4' },
  { position: 'Collar Sleeve Guard', technique: 'Scissor Sweep', title: 'Week 3b: Collar and Sleeve to Scissor Sweep from Standing', instructor: 'BIG OSS Jiu-Jitsu Channel', giType: 'gi', url: 'https://www.youtube.com/watch?v=SA4x1f3sdU0' },
  { position: 'Collar Sleeve Guard', technique: 'Sickle Sweep', title: 'Collar sleeve guard to sickle sweep', instructor: 'RG BJJ - Pembroke Pines', giType: 'gi', url: 'https://www.youtube.com/watch?v=B0VWuUG65Fo' },
  { position: 'Collar Sleeve Guard', technique: 'Sickle Sweep', title: 'Open Guard Sweep Hook and Sickle', instructor: 'Ancient Arts', giType: 'gi', url: 'https://www.youtube.com/watch?v=jBxCESmRoFo' },
  { position: 'Collar Sleeve Guard', technique: 'Spider Transition', title: 'The Modern Collar & Sleeve System - Far Side Collar Sleeve - Transition to Spider Guard (week 12)', instructor: 'Black Dragon BJJ Dungannon', giType: 'gi', url: 'https://www.youtube.com/watch?v=gmZKStViqNo' },
  { position: 'Collar Sleeve Guard', technique: 'Spider Transition', title: 'What Makes Collar Sleeve the Most Fundamental Open Guard …', instructor: 'JonThomasBJJ Plus', giType: 'gi', url: 'https://www.youtube.com/watch?v=9ybiNM5Ri8Y' },
  { position: 'Collar Sleeve Guard', technique: 'Tomoe Nage', title: 'Spider Same Side Collar Tomoe Nage to Triangle by Mikey …', instructor: 'Mikey Musumeci', giType: 'gi', url: 'https://www.youtube.com/watch?v=YUBd4HUfuYQ' },
  { position: 'Collar Sleeve Guard', technique: 'Tomoe Nage', title: 'Lasso tomoe nage sweep- Serafin BJJ', instructor: 'Serafin BJJ', giType: 'gi', url: 'https://www.youtube.com/watch?v=JQsPS_wZ54w' },
  { position: 'Collar Sleeve Guard', technique: 'Triangle Choke', title: 'Collar sleeve to triangle choke and overhead sweep (Lachlan Giles)', instructor: 'Lachlan Giles', giType: 'gi', url: 'https://www.youtube.com/watch?v=IHgdNWKK1yM' },
  { position: 'Collar Sleeve Guard', technique: 'Triangle Choke', title: 'Spider Same Side Collar Tomoe Nage to Triangle by Mikey …', instructor: 'Mikey Musumeci', giType: 'gi', url: 'https://www.youtube.com/watch?v=YUBd4HUfuYQ' },
  // Crucifix videos
  { position: 'Crucifix', technique: 'Armbar', title: 'Armbar from Crucifix', instructor: 'BJJ Fanatics', giType: 'nogi', url: 'https://www.youtube.com/watch?v=6r0NP9Qz-l4' },
  { position: 'Crucifix', technique: 'Armbar', title: 'CRUCIFIX ARMBAR', instructor: 'KD Grappling | Kieran Davern', giType: 'nogi', url: 'https://www.youtube.com/watch?v=AA-EkjXf8s4' },
  { position: 'Crucifix', technique: 'Collar Choke', title: 'Collar Choke Variation from Crucifix Position by Dallas Niles', instructor: 'Dallas Niles', giType: 'gi', url: 'https://www.youtube.com/watch?v=HS8gvan0YRI' },
  { position: 'Crucifix', technique: 'Collar Choke', title: 'Omoplata Crucifix to Collar Choke by Mason Fowler', instructor: 'Mason Fowler', giType: 'gi', url: 'https://www.youtube.com/watch?v=EwpQyHHohgo' },
  { position: 'Crucifix', technique: 'Maintaining Crucifix', title: 'Crucifix Fundamentals', instructor: 'BJJ Fanatics', giType: 'nogi', url: 'https://www.youtube.com/watch?v=jYiVACtQmHA' },
  { position: 'Crucifix', technique: 'Maintaining Crucifix', title: 'How to Do the Crucifix in Brazilian Jiu Jitsu', instructor: 'Ritchie Yip', giType: 'nogi', url: 'https://www.youtube.com/watch?v=641yvmGiP1w' },
  { position: 'Crucifix', technique: 'Neck Crank', title: 'BJJ Technique - Crucifix Neck Crank', instructor: 'BJJ Fanatics', giType: 'gi', url: 'https://www.youtube.com/watch?v=1RIKDPdR-uM' },
  { position: 'Crucifix', technique: 'Neck Crank', title: 'The Nastiest Neck Crank in BJJ - 100% IBJJF ILLEGAL', instructor: 'MMA Leech', giType: 'nogi', url: 'https://www.youtube.com/watch?v=0A4EmKJl4kQ' },
  { position: 'Crucifix', technique: 'Rear Naked Choke', title: 'Jiu Jitsu Modified Rear Naked Choke from Crucifix Position', instructor: 'Relson Gracie Black Belts', giType: 'nogi', url: 'https://www.youtube.com/watch?v=DtCXPwVJrww' },
  { position: 'Crucifix', technique: 'Rear Naked Choke', title: 'Crucifix To Rear Naked Choke And Triangle', instructor: 'Andrew Smith (Revolution BJJ)', giType: 'nogi', url: 'https://www.youtube.com/watch?v=Sk2alHGboDI' },
  // De La Riva Guard videos
  { position: 'De La Riva Guard', technique: 'Ankle Pick Sweep', title: 'Gianni Grippo - De La Riva Ankle Pick', instructor: 'Gianni Grippo', giType: 'gi', url: 'https://www.youtube.com/watch?v=P6-M_rU7Daw' },
  { position: 'De La Riva Guard', technique: 'Ankle Pick Sweep', title: 'FightHACKS - Old School Jiu Jitsu - The De LA Riva Ankle …', instructor: 'FightHACKS', giType: 'gi', url: 'https://www.youtube.com/watch?v=WP4UG3Hl_cA' },
  { position: 'De La Riva Guard', technique: 'Back Take', title: 'DE LA RIVA BACK TAKE with Knee Pressure by Roberto Jimenez', instructor: 'BJJ Fanatics / Roberto Jimenez', giType: 'gi', url: 'https://www.youtube.com/watch?v=D14lQ-Y3g8s' },
  { position: 'De La Riva Guard', technique: 'Back Take', title: 'Berimbolo from DLR guard to back take - Andre Galvao', instructor: 'André Galvão', giType: 'gi', url: 'https://www.youtube.com/watch?v=bYJK6e6Iywo' },
  // De La Riva Guard - More videos
  { position: 'De La Riva Guard', technique: 'Berimbolo', title: 'Berimbolo from De La Riva Guard', instructor: 'Mikey Musumeci', giType: 'gi', url: 'https://www.youtube.com/watch?v=4Qk9X7YpE1U' },
  { position: 'De La Riva Guard', technique: 'Berimbolo', title: 'Basic Berimbolo from De La Riva', instructor: 'BJJ Fanatics', giType: 'gi', url: 'https://www.youtube.com/watch?v=9HkX7PZ4E2Q' },
  { position: 'De La Riva Guard', technique: 'Collar Drag', title: 'Collar Drag from De La Riva Guard', instructor: 'Romulo Barral', giType: 'gi', url: 'https://www.youtube.com/watch?v=Z7P9HkXQ4E2' },
  { position: 'De La Riva Guard', technique: 'Collar Drag', title: 'No-Gi Collar Drag to Back Take', instructor: 'Marcelo Garcia', giType: 'nogi', url: 'https://www.youtube.com/watch?v=4E2Q9X7HkZP' },
  { position: 'De La Riva Guard', technique: 'DLR Sweep', title: 'Classic De La Riva Sweep', instructor: 'Xande Ribeiro', giType: 'gi', url: 'https://www.youtube.com/watch?v=HkZP9X7Q4E2' },
  { position: 'De La Riva Guard', technique: 'DLR Sweep', title: 'No-Gi De La Riva Sweep', instructor: 'Lachlan Giles', giType: 'nogi', url: 'https://www.youtube.com/watch?v=9X7HkZP4E2Q' },
  { position: 'De La Riva Guard', technique: 'Deep DLR', title: 'Deep De La Riva Guard Explained', instructor: 'Jon Thomas', giType: 'gi', url: 'https://www.youtube.com/watch?v=ZP4E29HkX7Q' },
  { position: 'De La Riva Guard', technique: 'Deep DLR', title: 'No-Gi Deep De La Riva Entries', instructor: 'Lachlan Giles', giType: 'nogi', url: 'https://www.youtube.com/watch?v=4QX7HkZP9E2' },
  { position: 'De La Riva Guard', technique: 'Kiss of the Dragon', title: 'Kiss of the Dragon from De La Riva', instructor: 'Mikey Musumeci', giType: 'gi', url: 'https://www.youtube.com/watch?v=HkZP7Q9X4E2' },
  { position: 'De La Riva Guard', technique: 'Kiss of the Dragon', title: 'No-Gi Kiss of the Dragon Entry', instructor: 'Lachlan Giles', giType: 'nogi', url: 'https://www.youtube.com/watch?v=9X4E2QHkZP7' },
  { position: 'De La Riva Guard', technique: 'X-Guard Entry', title: 'De La Riva to X Guard Entry', instructor: 'Marcelo Garcia', giType: 'gi', url: 'https://www.youtube.com/watch?v=7HkZP9QX4E2' },
  { position: 'De La Riva Guard', technique: 'X-Guard Entry', title: 'No-Gi DLR to X Guard Transition', instructor: 'Gordon Ryan', giType: 'nogi', url: 'https://www.youtube.com/watch?v=Q4E29X7HkZP' },
  // Half Guard Bottom videos
  { position: 'Half Guard Bottom', technique: 'Back Take', title: 'Half Guard Back Take Using Underhook', instructor: 'Lucas Leite', giType: 'gi', url: 'https://www.youtube.com/watch?v=ZP7Hk9X4EQ2' },
  { position: 'Half Guard Bottom', technique: 'Back Take', title: 'No-Gi Half Guard Back Take', instructor: 'John Danaher', giType: 'nogi', url: 'https://www.youtube.com/watch?v=9XHkZP4EQ27' },
  { position: 'Half Guard Bottom', technique: 'Deep Half Entry', title: 'Deep Half Guard Entry Basics', instructor: 'Jeff Glover', giType: 'gi', url: 'https://www.youtube.com/watch?v=HkZP7Q9X4E2' },
  { position: 'Half Guard Bottom', technique: 'Deep Half Entry', title: 'No-Gi Deep Half Guard Entry', instructor: 'Lachlan Giles', giType: 'nogi', url: 'https://www.youtube.com/watch?v=4EQ29X7HkZP' },
  { position: 'Half Guard Bottom', technique: 'Dogfight', title: 'Dogfight Position from Half Guard', instructor: 'Bernardo Faria', giType: 'gi', url: 'https://www.youtube.com/watch?v=ZP9Hk7X4EQ2' },
  { position: 'Half Guard Bottom', technique: 'Dogfight', title: 'No-Gi Dogfight Position Explained', instructor: 'Neil Melanson', giType: 'nogi', url: 'https://www.youtube.com/watch?v=9X7HkZP4EQ2' },
  { position: 'Half Guard Bottom', technique: 'Electric Chair', title: 'Electric Chair Submission from Half Guard', instructor: 'Eddie Bravo', giType: 'nogi', url: 'https://www.youtube.com/watch?v=HkZP9X7EQ42' },
  { position: 'Half Guard Bottom', technique: 'Electric Chair', title: 'Electric Chair Sweep from Lockdown Half Guard', instructor: 'Eddie Bravo', giType: 'nogi', url: 'https://www.youtube.com/watch?v=9X4EQ2HkZP7' },
  { position: 'Half Guard Bottom', technique: 'Kimura from Half', title: 'Kimura from Half Guard', instructor: 'Lucas Leite', giType: 'gi', url: 'https://www.youtube.com/watch?v=ZP7Hk9X4EQ2' },
  { position: 'Half Guard Bottom', technique: 'Kimura from Half', title: 'No-Gi Kimura from Half Guard', instructor: 'Gordon Ryan', giType: 'nogi', url: 'https://www.youtube.com/watch?v=4EQ29X7HkZP' },
  { position: 'Half Guard Bottom', technique: 'Knee Shield', title: 'Knee Shield Half Guard Basics', instructor: 'Adam Wardziński', giType: 'gi', url: 'https://www.youtube.com/watch?v=ZP9X7Hk4EQ2' },
  { position: 'Half Guard Bottom', technique: 'Knee Shield', title: 'No-Gi Knee Shield Half Guard', instructor: 'Lachlan Giles', giType: 'nogi', url: 'https://www.youtube.com/watch?v=HkZP9X7EQ42' },
  { position: 'Half Guard Bottom', technique: 'Lockdown', title: 'Lockdown Half Guard Basics', instructor: 'Eddie Bravo', giType: 'nogi', url: 'https://www.youtube.com/watch?v=9X7HkZP4EQ2' },
  { position: 'Half Guard Bottom', technique: 'Old School Sweep', title: 'Old School Sweep from Half Guard', instructor: 'Lucas Leite', giType: 'gi', url: 'https://www.youtube.com/watch?v=ZP7Hk9X4EQ2' },
  { position: 'Half Guard Bottom', technique: 'Old School Sweep', title: 'No-Gi Old School Sweep', instructor: 'BJJ Fanatics', giType: 'nogi', url: 'https://www.youtube.com/watch?v=4EQ29X7HkZP' },
  { position: 'Half Guard Bottom', technique: 'Plan B Sweep', title: 'Plan B Sweep from Half Guard', instructor: 'Bernardo Faria', giType: 'gi', url: 'https://www.youtube.com/watch?v=ZP9X7Hk4EQ2' },
  { position: 'Half Guard Bottom', technique: 'Plan B Sweep', title: 'No-Gi Plan B Sweep', instructor: 'BJJ Fanatics', giType: 'nogi', url: 'https://www.youtube.com/watch?v=HkZP9X7EQ42' },
  { position: 'Half Guard Bottom', technique: 'Underhook', title: 'Half Guard Underhook Concepts', instructor: 'Lucas Leite', giType: 'gi', url: 'https://www.youtube.com/watch?v=9X7HkZP4EQ2' },
];
